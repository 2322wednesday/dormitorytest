    ...
    constructor(target) {
        ...
        this.questions = {
            GHRS: [
                ...
                { question: '늦은 밤 거리를 홀로 걷던 당신은 마법과 관련된 것 같은 기이한 울음소리를 듣게 된다. 이때 당신의 선택은?', answer: { a:'지팡이를 한 손에 쥐고, 경계 태세를 하며 조심스레 걸어나간다', b: '지팡이를 꺼내들고 소리의 출처를 찾아본다', c:'지팡이를 꺼내들고 그 자리에 서서 맞선다', d:'문제 발생을 대비해 마음속으로 효과적 방어주문을 떠올리며 눈에 띄지 않는 곳으로 물러난다'}},
